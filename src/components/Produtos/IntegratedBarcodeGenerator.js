...
import { Download, BarChart3, Copy, Check, Settings, Eye, EyeOff, AlertTriangle, Save, History, Trash2 } from 'lucide-react';
import api from "../../../server/api/axiosConfig";
const IntegratedBarcodeGenerator = ({ productId, productCode, productName, productPrice, onClose, onBarcodeGenerated }) => {
    ...
    const generateBarcodeCanvas = (text, canvas) => {
        ...
        ctx.fillText(`${productCode} • ${productName} • R$ ${productPrice.toFixed(2)}`, totalWidth / 2, padding + barHeight + fontSize + 20);
    };
    // Atualizar canvas
    useEffect(() => {
