...
const ProductsPage = () => {
    ...
    return (_jsxs("div", { className: "p-6", children: [_jsxs("div", { className: "mb-6", children: [_jsxs("div", { className: "flex justify-between items-center mb-6", children: [_jsx("h1", { className: "text-2xl font-semibold text-gray-800", children: "Produtos" }), _jsxs("button", { onClick: () => setIsModalOpen(true), className: "flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700", children: [_jsx(Plus, { size: 20, className: "mr-2" }), "Novo Produto"] })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4", children: [_jsxs("div", { className: "bg-white p-4 rounded-lg shadow", children: [_jsx("h3", { className: "text-sm font-semibold text-gray-600", children: "Total de Produtos" }), _jsx("p", { className: "text-2xl font-semibold", children: estatisticas.totalProdutos })] }), _jsxs("div", { className: "bg-white p-4 rounded-lg shadow", children: [_jsx("h3", { className: "text-sm font-semibold text-gray-600", children: "Valor em Estoque" }), _jsxs("p", { className: "text-2xl font-semibold", children: ["R$ ", estatisticas.valorTotalEstoque.toLocaleString()] })] }), _jsxs("div", { className: "bg-white p-4 rounded-lg shadow", children: [_jsx("h3", { className: "text-sm font-semibold text-gray-600", children: "Produtos Ativos" }), _jsx("p", { className: "text-2xl font-semibold", children: estatisticas.produtosAtivos })] }), _jsxs("div", { className: "bg-white p-4 rounded-lg shadow", children: [_jsx("h3", { className: "text-sm font-semibold text-gray-600", children: "Produtos Consignados" }), _jsx("p", { className: "text-2xl font-semibold", children: estatisticas.produtosInativos })] })] })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5 mb-5", children: [_jsxs("div", { className: "relative", children: [_jsx("input", { type: "text", placeholder: "Buscar por nome, c\u00F3digo ou material...", className: "w-full pl-10 pr-4 py-2 border rounded-lg", value: searchTerm, onChange: (e) => setSearchTerm(e.target.value) }), _jsx(Search, { className: "absolute left-3 top-2.5 text-gray-400", size: 20 })] }), _jsxs("select", { value: filtroAvancado.categoria, onChange: (e) => setFiltroAvancado((prev) => ({
                            ...
                            setFiltroAvancado(prev => ({ ...prev, status: newStatus }));
                                            ...
                                            "Nenhum produto encontrado" }) })) : (products.map((product) => (_jsxs("tr", { className: `hover:bg-gray-50 ${product.found_by_material ? 'bg-blue-50 border-l-4 border-blue-400' : ''}`, children: [_jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900", children: _jsxs("div", { className: "flex items-center gap-2", children: [product.code, product.found_by_material && (_jsx("span", { className: "px-2 py-1 text-xs bg-blue-100 text-blue-800 rounded-full font-medium", children: "Material" }))] }) }), _jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-900", children: product.name }), _jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500", children: product.category }), _jsx("td", { className: "px-6 py-4 text-sm text-gray-500", children: _jsxs("div", { className: "flex flex-wrap gap-1 max-w-48", children: [product.materials && product.materials.length > 0 ? (product.materials.slice(0, 3).map((material, index) => (_jsx("span", { className: `inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${searchTerm && material.toLowerCase().includes(searchTerm.toLowerCase())
                    ...
                    setDeleteModalOpen(false);
                    setSelectedProduct(null);
                }, onConfirm: handleConfirmDelete, productId: selectedProduct.id.toString(), productName: selectedProduct.name }))] }));
};
