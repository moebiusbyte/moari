...
var ViewProductModal = function (_a) {
    ...
    var rawImages = Array.isArray(product.images) ? product.images : [];
    var images = rawImages.filter(function (img) { return img && typeof img === 'string' && img.trim() !== ''; });
    ...
    var imageSet = new Set(rawImages);
    ...
    rawImages.forEach(function (img, index) {
        console.log("Imagem ".concat(index, ":"), img);
        console.log("Tipo da imagem ".concat(index, ":"), typeof img);
        console.log("Length da imagem ".concat(index, ":"), img === null || img === void 0 ? void 0 : img.length);
    });
